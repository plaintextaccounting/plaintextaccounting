...
|--------------------------|------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------
| **User interfaces** <a name="user-interfaces"></a><a name="uis"></a>
...
| MUIs (Android):          | (cashier), <br>(NanoLedger)                                      | (cashier), <br>(MoLe), <br>(NanoLedger)                                                                                                                                              | (Beancount&nbsp;Mobile,&nbsp;CE), <br>(beancount-mobile)
...
| &nbsp;                   |                                                                  |                                                                                                                                                                                      | 
| **Other features** <a name="other-features"></a>
