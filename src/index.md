...
| Ruby Ledger        | [ruby][ruby_ledger-src]      | 2026   |              |           1 |      1 |
| <br>**Past/inactive**  |                          |        |              |             |        |
...
- [Countbean](https://github.com/CPUtester5465/countbean-plugin) - Claude Code plugin and MCP server for Beancount, using bean-check and git. Works with local files or countbean.com.
...
- [hledger-tui](https://github.com/lucabello/hledger-tui) TUI for hledger viewing (python, 2025)
...
- [Surebeans](https://surebeans.net) hledger-compatible YNAB clone, providing data entry, budgeting, reports (closed source, cross platform, C#, 2026)
